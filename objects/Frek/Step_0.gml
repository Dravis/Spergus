...
//Animation end
if sprite_index == s_FrekWalk and speed == 0
{
	sprite_index = s_FrekIdle
	state = "idle"
	substate = ""
}

if sprite_index == s_FrekIdle and speed != 0
{
	sprite_index = s_FrekWalk
	state = "walk"
	substate = ""
}
/**/