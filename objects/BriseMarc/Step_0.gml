...
instance_create_depth(x + sprite_height-768 + (image_xscale * 225), y-190 ,-y, LaserBit)
...
instance_create_depth(x + sprite_height-768 + (image_xscale * 125), y-190 ,-y, LaserBit)
		if instance_exists(LaserBase) = false
		{
			instance_create_depth(x + sprite_height-768 + (image_xscale * 125), y-190 ,-y, LaserBase)
		}
}
	}
	}
