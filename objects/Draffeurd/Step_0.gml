...
//Detects attack
if keyboard_check(vk_space) and sprite_index != s_DraffAttack
{
	hspeed = 0
	vspeed = 0
	canMove = false
...
//Animations
if (sprite_index == s_DraffAttack and image_index > image_number - 1)
{
