...
if keyboard_check(basicbtn) and state != "attack" and substate == ""
{
	...
	image_index=0
	hb = instance_create_depth(x + sprite_height-768 + (image_xscale * 175), y-50 , 0, Hitbox)	
	hb.creator = Draffeurd
}
