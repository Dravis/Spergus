...
if substate == "smashLoad" and !keyboard_check(smashbtn)
{
	...
	substate = ""
	canMove = false
	move_towards_point(x+(200*image_xscale),y,10)
	}

//Frame 8 is when the object is thrown
if image_index > 11 and substate = "smashLoad"
{
	substate = "rangedThrown"
	sack = instance_create_depth(x + (250 * image_xscale) , y-180 , 0, PotatoSack)
	sack.direction = 0
