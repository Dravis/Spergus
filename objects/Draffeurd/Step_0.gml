...
//Detects attack
if keyboard_check(vk_space) and state != "attack" and substate == ""
{
	hspeed = 0
	vspeed = 0
	canMove = false
...
//On "E" key release
if substate == "rangedThrow" and !keyboard_check(ord("E"))
{
	sprite_index= s_DraffPotatoThrow
	canMove = true
}
