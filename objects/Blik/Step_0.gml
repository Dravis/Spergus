...
if sprite_index == s_BlikCast2
	...
	if sprite_index == s_BlikPunch
	{
		...
		instance_create_depth(x + sprite_height-768 + (image_xscale * 175), y-50 ,-y, HitboxBlik)
...
if (image_index = image_number - 2)
{
	if sprite_index = s_BlikCast1
			{
			Barouet = instance_create_depth(x + sprite_height-768 + (image_xscale * 500), y-500 , -y, Barouette)
			Barouet.gravity = 0
			Barouet. speed = 0
			Barouet.rotspeed = 0
			}
