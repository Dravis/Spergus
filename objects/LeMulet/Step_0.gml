...
//Animation end
if sprite_index == s_MuletRun and speed == 0
{
	sprite_index = s_MuletIdle
	state = "idle"
	substate = ""
}

if sprite_index == s_MuletIdle and speed != 0
{
	sprite_index = s_MuletRun
	state = "walk"
	substate = ""
}
/**/