...
//Animation end
if sprite_index == s_StigWalk and speed == 0
{
	sprite_index = s_StigIdle
	state = "idle"
	substate = ""
}

if sprite_index == s_StigIdle and speed != 0
{
	sprite_index = s_StigWalk
	state = "walk"
	substate = ""
}
/**/